...
I am a **Class 7 student** and mobile enthusiast based in Nawada region of Bihar, India. I specialize in building high-performance native tools, Android applications, and custom terminal automation. All my development happens on mobile devices using Termux, proving that powerful software doesn't require expensive desktop setups.
...
> **System-Level Automation:** Experienced with using Shizuku via CLI rish scripts to safely manage Android permissions and bridge the gap between Termux and native Android APIs.

---

## Featured Projects

### `mkapk` — Native C++ Incremental Android Build System
...
* **Repository:** <a href="https://github.com/Nirbhay-Kumar-Developer/mkapk">https://github.com/Nirbhay-Kumar-Developer/mkapk</a>
...
* **Advanced Mathematics:** Passionate about Number Theory, Geometry proofs, and Mathematical Induction. 
...
## My Mobile Dev Setup
* **Terminal:** Termux with custom shell configuration including optimized aliases, functions, and build system integration
* **Editors:** `nano` and Code Studio (Android app) for writing efficient code on the go
* **Build Integration:** Direct integration with Android SDK/NDK and custom build tools within Termux environment
...
I'm open to collaboration, feedback, and discussing ideas about mobile development, low-level Android mechanics, or mathematics. Feel free to reach out!

**📧 Email:** <a href="mailto:dev.nirbhaykumar@gmail.com">dev.nirbhaykumar@gmail.com</a>
